	...
	m_collapsingStateOnLoad()
{
	...
	m_subWin = getGUI()->mainWindow()->addWindowedWidget( this );
...
void ControllerRackView::onControllerAdded(Controller * controller)
{
	...
	connect(controllerView, SIGNAL(deleteController(lmms::gui::ControllerView*)), this, SLOT(deleteController(lmms::gui::ControllerView*)), Qt::QueuedConnection);
	...
	connect(controllerView, SIGNAL(controllerMoveUp(lmms::gui::ControllerView*)), this, SLOT(moveControllerUp(lmms::gui::ControllerView*)));
	connect(controllerView, SIGNAL(controllerMoveDown(lmms::gui::ControllerView*)), this, SLOT(moveControllerDown(lmms::gui::ControllerView*)));
