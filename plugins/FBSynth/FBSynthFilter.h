/*
 * FBSynthfilter.cpp - declaration of FBSynthFilterclass.
 *
...
protected:
	...
	inline void setCoeffs(float a1, float a2, float b0, float b1, float b2)
	{
		...
		if (!m_initialized)
		{
			m_biQuadFrameInitial.setCoeffs(a1, a2, b0, b1, b2);
		}
	}
...
///
/// \brief The FBSynthLp12Filter class.
/// A 2 pole low pass filter
/// Coefficent calculations from http://www.musicdsp.org/files/Audio-EQ-Cookbook.txt
///
class FBSynthLp12Filter : public FBSynthFilter
{
public :
	virtual void calcCoefficents()
	{
...
///
/// \brief The FBSynthPeakFilter class
/// A Peak Filter
/// Coefficent calculations from http://www.musicdsp.org/files/Audio-EQ-Cookbook.txt
///
class FBSynthPeakFilter : public FBSynthFilter
{
public:
...
class FBSynthLowShelfFilter : public FBSynthFilter
{
public :
	virtual void calcCoefficents()
	{
...
class FBSynthHighShelfFilter : public FBSynthFilter
{
public :
	virtual void calcCoefficents()
	{
...
class FBSynthLinkwitzRiley : public StereoLinkwitzRiley
{
public:
	FBSynthLinkwitzRiley() :
