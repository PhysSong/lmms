	...
	m_instrument(instrument)
{
	...
	for (int i = 0; i < m_parameterWidget->bandCount() ; i++)
	{
		...
		activeButton->setActiveGraphic(PLUGIN_NAME::getIconPixmap(iconActiveFileName.toLatin1().constData()));
		activeButton->setInactiveGraphic(PLUGIN_NAME::getIconPixmap(iconInactiveFileName.toLatin1().constData()));
