/*
 * FBSynthCurve.h - defination of FBSynthCurve and FBSynthHandle classes.
 *
...
// implements the FBSynth_Handle to control a band
class FBSynthHandle : public QGraphicsObject
{
	Q_OBJECT
public:
	FBSynthHandle(int num, int x, int y);
...
class FBSynthCurve : public QGraphicsObject
{
	Q_OBJECT
public:
	FBSynthCurve(QList<FBSynthHandle*> *handle, int x, int y);
	QRectF boundingRect() const;
