...
double * OrganicInstrument::s_harmonics = nullptr;
...
/*	m_osc[0]->m_harmonic = log2( 0.5 );	// one octave below
	...
	m_osc[2]->m_harmonic = log2( 1.0 );	// base freq
	m_osc[3]->m_harmonic = log2( 2.0 );	// first overtone
	m_osc[4]->m_harmonic = log2( 3.0 );	// second overtone
	m_osc[5]->m_harmonic = log2( 4.0 );	// .
	m_osc[6]->m_harmonic = log2( 5.0 );	// .
	m_osc[7]->m_harmonic = log2( 6.0 );	// .*/
	...
	if( s_harmonics == nullptr )
	{
		...
		s_harmonics[2] = log2( 1.0 );
		s_harmonics[3] = log2( 2.0 );
		s_harmonics[4] = log2( 3.0 );
		s_harmonics[5] = log2( 4.0 );
		s_harmonics[6] = log2( 5.0 );
		s_harmonics[7] = log2( 6.0 );
		s_harmonics[8] = log2( 7.0 );
		s_harmonics[9] = log2( 8.0 );
		s_harmonics[10] = log2( 9.0 );
		s_harmonics[11] = log2( 10.0 );
		s_harmonics[12] = log2( 11.0 );
		s_harmonics[13] = log2( 12.0 );
		s_harmonics[14] = log2( 13.0 );
		s_harmonics[15] = log2( 14.0 );
		s_harmonics[16] = log2( 15.0 );
		s_harmonics[17] = log2( 16.0 );
	}
